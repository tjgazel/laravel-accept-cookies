@if(!session()->has(config('accept-cookies.sessionName')))
    <div class="cookies-info-b4 pt-4 {{config('accept-cookies.backgroundColor')}}"
        ...
        <div class="cookies-info-b4-content text-center pt-3 pb-2">
            ...
            <button class="cookies-info-btn1 btn btn-link font-weight-bolder my-3 mx-2 {{config('accept-cookies.btnAcceptColor')}}"
                    style="text-decoration: underline">
                {!! config('accept-cookies.btnAcceptText') !!}
            </button>
            <button class="cookies-info-btn2 btn btn-link font-weight-bolder my-3 mx-2 {{config('accept-cookies.btnRefuseColor')}}"
                    style="text-decoration: underline">
    ...
    @push('js')
        <script>
            $(document).ready(function () {
                var url = '/' + {{config('accept-cookies.route.prefix')}} + {{config('accept-cookies.route.route.url')}};
